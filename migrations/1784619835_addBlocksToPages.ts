...
export default async function (client: Client) {
  ...
  console.log(
    'Create Single-line string field "Layout" (`layout`) in block model "\uD83D\uDCDD Text Block" (`text_block`)',
  );
  await client.fields.create("BSet0e3fTeWC8-a8odR7VA", {
    id: "I77l-rzcRaqrWAFbEGFDDA",
    label: "Layout",
    field_type: "string",
    api_key: "layout",
    validators: { required: {}, enum: { values: ["left", "centered"] } },
    appearance: {
      addons: [],
      editor: "single_line",
  ...
  console.log(
    'Create Single-line string field "Style" (`style`) in block model "\uD83D\uDCDD Text Block" (`text_block`)',
  );
  await client.fields.create("BSet0e3fTeWC8-a8odR7VA", {
    id: "A8JsuJeYRtuz0VWP6tHLwg",
    label: "Style",
    field_type: "string",
    api_key: "style",
    validators: { required: {}, enum: { values: ["default", "highlight"] } },
    appearance: {
      addons: [],
      editor: "single_line",
      parameters: { heading: false, placeholder: null },
  ...
  await client.fields.update("N9_Px6jOQAOzXuGm7zjfeg", {
    validators: {
      required: {},
      structured_text_blocks: {
        item_types: ["41672", "1775016", "2040401", "2040408"],
      },
