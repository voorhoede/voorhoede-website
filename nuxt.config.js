  ...
  */
  head: {
    ...
    meta: [
      ...
      { 'name': 'subject', 'content': 'Website for De Voorhoede' },
      { 'name': 'description', 'content': 'We bouwen front-end oplossingen waarmee je jaren vooruit kunt' },
      { 'name': 'keywords', 'content': 'front-end, developers, programmeurs, web, HTML, CSS, JS, JavaScript, team, Amsterdam' },
