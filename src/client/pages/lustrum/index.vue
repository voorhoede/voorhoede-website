<template>
  <main class="page-lustrum grid">
    ...
    <div class="page-lustrum__list">
      <h2 class="page-lustrum__title-events h3">{{ page.eventsTitle }}</h2>
      <ul>
        <li
          v-for="event in page.eventsList"
          :key="event.id">
    ...
    <div class="page-lustrum__list">
      <h2 class="page-lustrum__title-blogs h3">{{ page.blogsTitle }}</h2>
      <ul>
        <li v-for="blogPost in page.blogsList.filter(post => post.published)" :key="blogPost.slug">
