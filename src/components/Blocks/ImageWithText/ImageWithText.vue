  ...
  <div
    ...
    :class="{
      ...
      'image-with-text--pastel-background':
        data.backgroundColor === 'pastel-yellow',
    }"
  >
    <DatoImage
    ...
    <div class="image-with-text__body">
      ...
      <StructuredTextBlock
        ...
        :content="data.body"
        :paragraph-variant="data.fontSize === 'small' ? 'body' : 'body-big'"
      />
    </div>
  </div>
</template>
...
import { type ImageWithTextFragment } from "./ImageWithText.query";
...
const props = defineProps<{
  data: FragmentOf<typeof ImageWithTextFragment>;
}>();

const data = readFragment<typeof ImageWithTextFragment>(props.data);
</script>
