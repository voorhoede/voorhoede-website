<template>
  <div class="case-meta is-animated">
    ...
    <div class="case-meta__section animation__uncover animation__uncover--white-background animation-stagger-1">
      <h3 class="case-meta__title body font-bold">
        {{ expertiseTitle }}
      </h3>
      <p class="body-small">
        {{ toMetaString(expertises) }}
      </p>
    </div>
    ...
    <div class="case-meta__section animation__uncover animation__uncover--white-background animation-stagger-3">
      ...
      <p class="body-small">
        {{ toMetaString(deliverables) }}
      </p>
    </div>

    <div
      v-if="interestedTitle"
      class="case-meta__section animation__uncover animation__uncover--white-background animation-stagger-4"
    >
      <h3 class="case-meta__title body font-bold">
        {{ interestedTitle }}
      </h3>
